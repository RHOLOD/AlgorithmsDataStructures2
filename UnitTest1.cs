...
namespace UnitTestAlgo2
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void TestMetho1211() // проверка родителя узла 19
        {
            /// дерево 33, 5, 35, 1, 20, 99, 17, 18, 19, 4
            /// 
            ///                       33
        ...
        public void TestMetho121() // удаления  5 проверка родителя узла 19
        {
            /// дерево 33, 5, 35, 1, 20, 99, 17, 18, 19, 4
            /// 
            ///                       33
        ...
        [TestMethod]
        public void TestMetho123() // удаления  5 проверка родителя узла 19
        {
            /// дерево 33, 5, 35, 1, 20, 99, 17, 18, 19, 4
            /// 
            ///                       33
            ...
            BSTFind<string> bSTFind = bST1.FindNodeByKey(19);
            var expected = 19;
            var result = bSTFind.Node.Parent.RightChild.NodeKey;

            Assert.AreEqual(expected, result);
        }
        [TestMethod]
        public void TestMetho124() // удаления  5 проверка родителя узла 19
        {
            /// дерево 33, 5, 35, 1, 20, 99, 17, 18, 19, 4
            /// 
            ///                       33
            ...
            var result = bSTFind.Node.Parent.LeftChild;
        ...
        public void TestMetho125() // удаления  5 проверка родителя узла 19
        {
            ...
            BSTFind<string> bSTFind = bST1.FindNodeByKey(19);
            var expected = 33;
            var result = bSTFind.Node.Parent.Parent.Parent.NodeKey;
        ...
        [TestMethod]
        public void TestMetho22()  //проверка FindNodeByKey() после удаления  5 
        {
            ///                       33
            ///         -5                        35
            ///     1       17                         99
        ...
        [TestMethod]
        public void TestMetho23()  //проверка FindNodeByKey() после удаления  5 
        {
            ///                       33
            ///         -5                        35
            ///     1       17                         99
        ...
        [TestMethod]
        public void TestMetho24()  //проверка FindNodeByKey() после удаления  5 
        {
            ///                       33
            ///         -5                        35
            ///     1       17                         99
        ...
        [TestMethod]
        public void TestMetho25()  //проверка FindNodeByKey() после удаления  31
        {
            ///                       5
            ///                  1           35
            ///                    4       17      99
            ...
            BSTNode<string> root = new BSTNode<string>(5, "", null);
            BST<string> bST1 = new BST<string>(root);
            bST1.AddKeyValue(1, "");
            bST1.AddKeyValue(4, "");
            bST1.AddKeyValue(35, "");
            ...
            bool b11 = bST1.DeleteNodeByKey(31);
        ...
        [TestMethod]
        public void TestMetho26()  //проверка FindNodeByKey() после удаления  31
        {
            ///                       5
            ///                  1           35
            ///                    4       17      99
        ...
        [TestMethod]
        public void TestMetho27()  //проверка FindNodeByKey() после удаления  31
        {
            ///                       5
            ///                  1           35
            ///                    4       17      99
            ...
            BSTFind<string> bSTFind = bST1.FindNodeByKey(22);
            var expected = 33;
            var result = bSTFind.Node.Parent.NodeKey;
        ...
        [TestMethod]
        public void TestMetho28()  //проверка FindNodeByKey() после удаления  31
        {
            ///                       5
            ///                  1           35
            ///                    4       17      99
            ...
            BSTFind<string> bSTFind = bST1.FindNodeByKey(19);
            var expected = 34;
            var result = bSTFind.Node.RightChild.NodeKey;

            Assert.AreEqual(expected, result);
        }
        [TestMethod]
        public void TestMetho29()  //проверка FindNodeByKey() после удаления  35
        {
            ///                       5
            ///                  1           (35)
            ///                    4       17      99
            ...
            bool b11 = bST1.DeleteNodeByKey(35);


            BSTFind<string> bSTFind = bST1.FindNodeByKey(99);
            var expected = 5;
            var result = bSTFind.Node.Parent.NodeKey;
        ...
        [TestMethod]
        public void TestMetho30()  //проверка FindNodeByKey() после удаления  35
        {
            ///                       5
            ///                  1           (35)
            ///                    4       17      99
        ...
        [TestMethod]
        public void TestMetho31()  //проверка FindNodeByKey() после удаления  35
        {
            ///                       5
            ///                  1           (35)
            ///                    4       17      99
        ...
        [TestMethod]
        public void TestMetho32()  //проверка FindNodeByKey() после удаления  5
        {
            ///                       (5)
            ///                  1           35
            ///                    4       17      99
